...
nur_all := nur-program-learning nur-ryan4yin nur-linyinfeng nur-xddxdd nur-AtaraxiaSjel llqqnt browser-previews firefox-nightly LaphaeL-aicmd nur-DataEraserC nixpkgs-latest
